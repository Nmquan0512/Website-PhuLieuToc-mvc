        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetOtp = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ResetOtpExpiryUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResetOtpAttempts = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
